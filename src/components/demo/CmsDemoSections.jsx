...
const SECTION_RENDERERS = {
  ...
  "header-with-city-info": ({ lang, dir, headerWithCityInfoData }) => (
  ...
  "cities-sections": ({ lang, dir, citiesSectionsData }) => (
  ...
  "banner-with-ctas-and-items": ({ lang, dir, bannerWithCTAsAndItemsData }) => (
    <BannerWithCTAsAndItemsContainer lang={lang} dir={dir}>
      <BannerWithCTAsAndItems lang={lang} data={bannerWithCTAsAndItemsData} />
    </BannerWithCTAsAndItemsContainer>
  ),
  "banner-with-cta": ({ lang, dir, bannerWithCtaData }) => (
    <BannerWithCtaContainer lang={lang} dir={dir}>
      <BannerWithCta lang={lang} data={bannerWithCtaData} />
    </BannerWithCtaContainer>
  ),
  "data-table-with-image": ({ lang, dir, dataTableWithImageData }) => (
  ...
  "service-benefits-list": ({ lang, dir, serviceBenefitsData }) => (
  ...
  "header-with-three-image": ({ lang, dir, headerWithThreeImageData }) => (
  ...
  "carousel-image-text-6": ({ lang, dir, carouselImageText6Data }) => (
  ...
  "related-content-carousel": ({ lang, dir, relatedContentCarouselData }) => (
    <RelatedContentCarouselContainer lang={lang} dir={dir}>
      <RelatedContentCarousel lang={lang} data={relatedContentCarouselData} />
    </RelatedContentCarouselContainer>
  ),
  "cards-carousel-fill-image": ({ lang, dir, cardsCarouselFillImageData }) => (
    <CardsCarouselFillImageContainer lang={lang} dir={dir}>
      <CardsCarouselFillImage lang={lang} data={cardsCarouselFillImageData} />
    </CardsCarouselFillImageContainer>
  ),
  "meals-description-tabbed": ({ lang, dir, mealsDescriptionTabbedData }) => (
    <MealsDescriptionTabbedContainer lang={lang} dir={dir}>
      <MealsDescriptionTabbed lang={lang} data={mealsDescriptionTabbedData} />
    </MealsDescriptionTabbedContainer>
  ),
  "connection-steps-list": ({ lang, dir, connectionStepsListData }) => (
  ...
  "dual-image-text-training": ({ lang, dir, dualImageTrainingData }) => (
    <DualImageTextContainer lang={lang} dir={dir}>
      <DualImageText
        lang={lang}
  ...
  "destination-showcase": ({ lang, dir, destinationShowcaseData }) => (
  ...
  "carousel-item": ({ lang, dir, carouselItemData }) => (
  ...
  "legal-body-cookies": ({ lang, dir, legalBodyCookiesData }) => (
