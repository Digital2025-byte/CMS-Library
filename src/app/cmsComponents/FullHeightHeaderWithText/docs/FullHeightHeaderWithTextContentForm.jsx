...
export default function FullHeightHeaderWithTextContentForm({
  content,
  onChange,
  defaults,
}) {
  ...
  return (
    <div>
      ...
      <InspectorButtonSection
        idPrefix="full-height-header-button"
      ...
      <InspectorSection title="Image" onReset={() => reset(IMAGE_KEYS)}>
        <InspectorField
          id="full-height-header-image"
          label="Image URL"
          value={content.imageUrl || ""}
          onChange={(value) => updateField("imageUrl", value)}
        />
        <InspectorField
          id="full-height-header-alt"
          label="Image alt"
