  ...
  return (
    ...
    >
      <PageContentContainer>
        <div className="mb-12 mt-8 grid w-full grid-cols-1 gap-4 lg:grid-cols-2">
          <div className="order-2 mt-1 flex flex-col justify-center py-4 lg:order-1">
            {first.title ? (
              <div>
          ...
          <div className="order-1 flex justify-center py-4 lg:order-2">
            {first.imageUrl ? (
              <Image
          ...
          <div className="order-3 flex justify-center py-4 lg:order-3">
            {second.imageUrl ? (
              <Image
          ...
          <div className="order-4 mb-1 mt-1 flex flex-col justify-center py-4 lg:order-4">
            {second.title ? (
              <div>
